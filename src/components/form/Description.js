    ...
    return (
      <div style={{ margin: 20 }}>
        ...
        <p className="margin-tb10">
          To confirm whether we can accept your donation, you can upload up to 5
          photos of an item you would like to donate with a brief description.
          Our staff will reach out to you to confirm if we can take the item or
          not. If we can’t accept your item, we can help you find the best place
          to take it.
        </p>
        <p className="margin-tb10">
